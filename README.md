...
Usage:
1. Hook Arduino to Xboxes SMBus, (SDA,CLK and GND), wait for Xenium to boot into XeniumOS. Confirm you have graphical issues as described here https://github.com/Ryzee119/OpenXenium/issues/2.
